...
após configuração salva no portal NFE.io
Série: IO
Número: 2
"""
import os
...
def update_rps_config(serie="IO", numero=2, lote=1):
    """
...
if __name__ == "__main__":
    ...
    logger.info("Série: IO, Número: 2 (Após configuração no portal NFE.io)")
    
    # Atualizar configuração RPS para os valores especificados
    config = update_rps_config(serie="IO", numero=2, lote=1)
